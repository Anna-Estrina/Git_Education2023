...
Чтобы отправить изменения в удалённый репозиторий достаточно ввести команду **_git push_**. Перед командой **_git push_** необходимо сделать коммит.
