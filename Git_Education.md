...
git push -u origin main
```
Первый вариант предусматривает работу с нуля, то есть, когда ещё ничего не создано ни в удалённом, ни в локальном репозиториях.

Второй вариант позволит привязать удалённый репозиторий к уже созданному локальному репозиторию.

## 14. Связываание локального и удалённого репозитория.
