...
> После того, как все необходимые данные в ветке прописаны, записыны и создан коммит, необходимо слить всё в главную ветку **master (main)**. Для этого нужно перейти в ветку **master (main)** и задать комманду 
