...
После данных манипуляций переходим в **GitHab**. После обновления страницы наш локальный репозиторий появляется в удалённом репозитории.Важно обратить внимание на то, что возле файла .md, в котором мы работали появится наименование последнего коммита.
