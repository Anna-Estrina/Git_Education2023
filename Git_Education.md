...
**GitHab** позволяет создать удалённый репозиторий на самой платформе. Для этого в верхнем правом углу необходимо нажать кнопку ➕. Эта кнопка есть всегда, вне зависимости от того, в какой части сайта мы находимся.![Рис.21](Image\Рис.21.jpg).
